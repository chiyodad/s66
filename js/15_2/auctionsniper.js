	...
	render(){
		...
		for(i = 0; i < this.getRowCount(); i++){
			...
			for(j = 0; j < this.getColumeCount(); j++){
				...
				cell.style.cssText = 'padding:0;border-bottom:1px solid #000;border-right:1px solid #000;'
...
const Driver = class{
	...
	showSniperStatus(itemId, lastPrice, lastBid, statusText){
		...
		console.log(target);
		console.log(itemId, lastPrice, lastBid, statusText + '');
